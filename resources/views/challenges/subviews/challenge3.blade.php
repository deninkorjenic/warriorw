  ...
  <div class="card-content">
    <div class="row">
      ...
      <div class="col s12 m4 l4">
        ...
        <ul class="collection">
          <li class="collection-item"><strong>Start date:</strong> {{ $c3->start->date->day }}.{{ $c3->start->date->month }}.{{ $c3->start->date->year }}.
          </li>
          <li class="collection-item"><strong>End date:</strong> {{ $c3->end->date->day }}.{{ $c3->end->date->month }}.{{ $c3->end->date->year }}.</li>
          ...
          <li class="collection-item"><strong>My score:</strong> {{ $c3->points }} </li>
        </ul>
      </div>
    </div>
    <div class="row">
      <div class="col s12">
        <span class="card-title">Habits to hit</span>
        <div class="row">
          <div class="col s12">
